package com.crowdstaffing.pom.util;
...
public class Constants {
    ...
    public static final String STAGE_HOMEPAGE_URL = "https://auth.uat.crowdstaffing.com";
    ...
    public static final String STAGE_BASE_URI = "https://auth.uat.crowdstaffing.com/login";

    public static final String STAGE_PASSWORD2 = "dev@ranker";
    // URLs-uat
    public static final String UAT_HOMEPAGE_URL = "https://auth.uat.crowdstaffing.com";
